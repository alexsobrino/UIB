...
void servidor (int cola_s, int cola_r)
{
	...
	while (1) {
		...
		printf("hago algo...\n");
		printf("COLA: pid %d tipo %d tamano %d posicion %d nombre %s info %s\n",msg1.pid,msg1.contenido.tipo,msg1.contenido.tamano,msg1.contenido.posicion,msg1.contenido.nombre,msg1.contenido.info);
		//switch (msg1.contenido.tipo) {
			//case(0): 
		if (msg1.contenido.tipo == 0) {
			...
			printf("OBALAAAAAAAAAAAAAAAAAAAAAAAAAA\n");
